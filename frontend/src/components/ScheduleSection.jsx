...
const ScheduleSection = () => {
  return (
    ...
    >
      ...
      <Box bgColor="rgba(0,0,0,0.3)" mt={35} width="571px" height="224px" borderRadius="20px" pl={30}>
        <Flex alignItems={"center"}>
          <Box mt={30}>
            <Image src={speakin_img} alt="speakin" width="157px" height="45px" />
          </Box>
          <Box mt={30} ml={3}>
        ...
        <Box>
          <Box textAlign={"left"} mt={5}>
            <Text color="rgba(255, 255, 255, 1)" fontSize="22px" height={31} fontWeight={400}>
